...
def message_mail(name, phone, address, textarea):
	...
	message["To"] = " Ravibharat2720@gmail.com"
	message.attach(MIMEText(body, 'plain'))

	s.sendmail(MAIL_ID, " Ravibharat2720@gmail.com", message.as_string())
...
def message_mail(name,phone,address,company,model):
	s = smtplib.SMTP('smtp.gmail.com', 587)  
	s.starttls() 
